            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.replyMessage }"
                        >
                            ...
                            <small
                                ...
                                v-text="errors.replyMessage[0]"
                            ></small>
                        </div>
                    </div>
                    <div class="col-12" v-if="form.type == 'media'">
                        <div
                            class="form-group pt-2"
                            :class="{ 'has-danger': errors.media }"
                        >
                            ...
                            >
                                ...
                                <div slot="tip" class="el-upload__tip">
                                    Solo archivos con un tamaño menor de 5mb
                                </div>
                            </el-upload>
                            <small
                                class="text-danger"
                                v-if="errors.media"
                                v-text="errors.media[0]"
                            ></small>
                        </div>
                    </div>
                    <div class="col-lg-4 pt-2">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.option_key }"
                        >
                            <label class="control-label w-100"
                                >Palabra Clave</label
                            >
                            <el-select v-model="form.option_key" filterable>
                                <el-option
                            ...
                            <small
                                class="text-danger"
                                v-if="errors.option_key"
                                v-text="errors.option_key[0]"
                            ></small>
                        </div>
                    </div>
                    <div class="col-lg-4 pt-2">
...
export default {
    ...
    data() {
        return {
            ...
            action: this.api_whatsapp + "/api/uploadfiles_boot",
            errors: {},
            form: {},
            fileList: [],
    ...
    methods: {
        ...
        async create() {
            ...
            await this.$http
                .get(
                    `${this.api_whatsapp}/api/questions/records/${this.sender}`
                )
                .then((response) => {
