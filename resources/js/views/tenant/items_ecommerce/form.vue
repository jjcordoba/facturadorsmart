            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div
                            :class="{
                                'has-danger': errors.technical_specifications,
                            }"
                            class="form-group"
                        >
                            <label class="control-label"
                            ...
                            ></el-input>
                            <small
                                v-if="errors.technical_specifications"
                                class="text-danger"
                                v-text="errors.technical_specifications[0]"
                            ></small>
                        </div>
                    </div>
                    ...
                    <div v-show="recordId == null" class="col-md-3">
                        <div
                    ...
                    <div class="col-md-3">
                        <div
                            :class="{ 'has-danger': errors.descuento_store }"
                            class="form-group"
                        >                <label class="control-label">Descuento en tienda</label>
                            <el-input
                            type="number"
                            step="any"
                                v-model="form.descuento_store"
                                placeholder="Descuento en tienda"
                            ></el-input>
                            <small
                                v-if="errors.descuento_store"
                                class="text-danger"
                                v-text="errors.descuento_store[0]"
                            ></small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 center-el-checkbox">
                        <div class="form-group">
                            <el-checkbox
                                v-model="has_percentage_perception"
                                @change="changePercentagePerception"
                                >Incluye percepción
                            </el-checkbox>
                            <br />
                        </div>
                    ...
                    <div
                        v-show="has_percentage_perception"
                        class="col-md-3 center-el-checkbox"
                    >
                        <div class="form-group">
                            <label class="control-label"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="sub-title text-danger">
                                    <small
                                        >Se recomienda resoluciones Full Hd
                                        1024x720</small
                                    >
                                </div>
                                <el-button type="primary" @click="openImages"
                                    >Agregar más fotos
                                </el-button>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        calculatePercentageOfProfitBySale() {
            ...
            if (parseFloat(this.form.purchase_unit_price) === 0) {
                ...
                this.form.percentage_of_profit =
                    (difference / parseFloat(this.form.purchase_unit_price)) *
                    100;
            }
        },
        calculatePercentageOfProfitByPurchase() {
        ...
        submit() {
            if (
                this.has_percentage_perception &&
                !this.form.percentage_perception
            )
