<template>
    <div>
        ...
        <el-dialog
            ...
            width="650px"
        >
            <template v-if="!configuration.pos_cash_counter">
            ...
            <template v-else>
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>De 10 centavos</td>
                            <td>
                                <el-input
                                    class="w-100 text-right"
                                    type="number"
                                    v-model="counter['0.10']"
                                    placeholder="0"
                                    @input="changeCounter"
                                >
                                </el-input>
                        ...
                        <tr>
                            <td>De 20 centavos</td>
                            <td>
                                <el-input
                                    class="w-100 text-right"
                                    type="number"
                                    v-model="counter['0.20']"
                                    placeholder="0"
                                    @input="changeCounter"
                                >
                                </el-input>
                        ...
                        <tr>
                            <td>De 50 centavos</td>
                            <td>
                                <el-input
                                    class="w-100 text-right"
                                    type="number"
                                    v-model="counter['0.50']"
                                    placeholder="0"
                                    @input="changeCounter"
                                >
                                </el-input>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-end">
                                <el-button type="info" @click="restoreCounter"
                        ...
                        <tr>
                            <td colspan="4">
                                <strong> TOTAL: {{ countMoney }} </strong>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
export default {
    ...
    methods: {
        ...
        changeCounter() {
            //sumar los valores de los billetes y monedas
            let total = 0;
            for (const key in this.counter) {
                total += this.counter[key] * parseFloat(key);
                total = Math.round(total * 100) / 100;
            }
            this.countMoney = total;
        },
        initCounter() {
            this.counter = {
                "0.10": 0,
        ...
        async closeCash() {
            try {
                ...
                const response = await this.$http.post(
                    `/${this.resource}/close/${this.recordId}`,
                    {
        ...
        clickDownloadReport(id, template, mm = 80) {
            if (template == "ticket") {
                ...
                else if (template == "simple_a4_seller") {
                window.open(
                    `/${this.resource}/simple-seller/report-a4/${id}/`,
                    "_blank"
                );
            } 
            else {
