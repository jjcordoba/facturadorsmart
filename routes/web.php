...
Route::post('/reservaciones/public', [CanchaController::class, 'publicStore'])->name('tenant.canchas.publicStore');
...
Route::prefix('canchas')->group(function () {
    Route::get('/', [CanchaController::class, 'records'])->name('tenant.canchas.index');
    Route::get('/{id}', [CanchaController::class, 'record'])->name('tenant.canchas.show');
    ...
    Route::get('/reservas', [CanchaController::class, 'reservas'])->name('tenant.canchas.reservas');
