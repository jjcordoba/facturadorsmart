  ...
  <div class="col-xl-6 col-md-8">
    <section class="card card-dashboard" style="margin-bottom: 10px;">
            ...
            <tbody>
              <template v-for="(row, index) in items_by_sales">
                <tr :key="index">
                  <td>{{ index + 1 }}</td>
                  <td>
                    <img :src="`/storage/uploads/items/${row.image}`" alt="Imagen del producto" style="width: 50px; height: 50px; object-fit: cover; border-radius: 4px;">
                  </td>
      ...
      <div class="card-body" style="
        text-align: center;
        padding-top: 10px;">
<a class="btn btn-primary btn-sm" href="/reports/general-items">
  Ver todo
</a>
  ...
  <div class="col-xl-6 col-md-6">
    <section class="card card-dashboard" style="margin-bottom: 10px;">
      ...
      <div class="card-body p-0" v-show="!loaders.top_customers">
        <ul class="transaction-list" style="
          list-style-type: none;
          padding: 0;
          margin: 0;">
          <li class="transaction-card" v-for="(row, index) in top_customers" :key="index" style="
            display: flex;
            align-items: center;
            padding: 5px;
            border-bottom: 1px solid #eee;
            ...
            <div style="flex-grow: 1;">
              <div style="font-weight: bold;">Nombre: {{ row.name }}</div>
              <div class="text-small text-muted">
                Número de documento: {{ row.document_type }} {{ row.number }}
              </div>
            </div>
            <div style="text-align: right; margin-left: 10px;">
              <div class="text-muted">
                Transacciones: {{ row.transaction_quantity }}
              </div>
              <div class="text-muted">
                Total: {{ row.total }}
                <i class="text-primary icofont-money-bag"></i>
              </div>
            </div>
          </li>
        </ul>
